---
name: van
description: "Analyses context, estimates task complexity (Level 1-4), validates Git branch state, and recommends the next workflow step (PLAN, CREATIVE, or IMPLEMENT). Use this mode at the start of any new task to assess scope and determine the right approach."
