---
name: implement
description: "Turns the approved plan into working code and updates the task checklist accordingly. Works through tasks sequentially, runs tests after each change, maintains code quality, and keeps the memory bank updated with progress and decisions."
