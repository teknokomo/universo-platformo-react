...
-   [`@universo/profile-backend`](../profile-backend/README-RU.md) - Бэкенд сервис профилей
-   [`@universo/auth-frontend`](../auth-frontend/README-RU.md) - Фронтенд аутентификации
-   [`@universo/i18n`](../universo-i18n/README-RU.md) - Интернационализация
