...
import { createMockDataSource, createMockRepository, createMockQueryBuilder } from '@testing/backend/typeormMocks'
...
describe('CanvasService', () => {
    const createService = () => {
        ...
        const spaceCanvasRepo = createMockRepository<SpaceCanvas>({
            ...
            save: jest.fn(
                async (entity?: Partial<SpaceCanvas>) =>
                    ({
                        id: 'sc-1',
