...
- 🗂️ Архитектура множественных холстов с отношениями пространство-холст
- 📊 PostgreSQL база данных с интеграцией TypeORM
- 🛡️ Row Level Security (RLS) с аутентификацией Supabase
- 🔄 Возможности упорядочивания и переупорядочивания холстов
- 🏢 Интеграция с системой рабочих пространств Unik
- 📦 RESTful API для управления пространствами и холстами
