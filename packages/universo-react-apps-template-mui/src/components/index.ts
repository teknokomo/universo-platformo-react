...
export { EditorJsBlockEditor } from '@universo-react/block-editor'
export type { EditorJsBlockEditorLabels, EditorJsBlockEditorProps } from '@universo-react/block-editor'
