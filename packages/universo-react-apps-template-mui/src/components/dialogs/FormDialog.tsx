...
import { normalizePageBlockContentForStorage, parseSafeExternalUrl, RESOURCE_TYPES, resourceSourceSchema } from '@universo-react/types'
 ...
 * Matches component validation rules from @universo-react/types.
 */
