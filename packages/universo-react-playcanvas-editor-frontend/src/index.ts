...
export const PLAYCANVAS_EDITOR_UPSTREAM_TAG = 'v2.30.4'
export const PLAYCANVAS_EDITOR_UPSTREAM_COMMIT = 'cf296bcb669bdcb168778bf2979160a9fe8f67de'
export const PLAYCANVAS_EDITOR_UPSTREAM_PACKAGE_VERSION = '2.30.4'
