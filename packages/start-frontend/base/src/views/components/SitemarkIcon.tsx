/**
 * SitemarkIcon - Universo logo with text
 *
 * SVG logo containing:
 * - Three colored geometric shapes (gray, purple, blue)
 * - "Universo" text in brand blue color
 */
    ...
    return (
        <SvgIcon sx={{ height: 21, width: 100, mr: 2 }}>
            <svg width={100} height={19} viewBox='0 0 100 19' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                />
                {/* "Universo" text */}
                <text x='22' y='14' fill='#4876EE' fontFamily='Inter, Arial, sans-serif' fontSize='14' fontWeight='600'>
                    Universo
                </text>
            </svg>
        </SvgIcon>
