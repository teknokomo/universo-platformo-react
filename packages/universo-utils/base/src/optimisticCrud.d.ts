...
import { getNextOptimisticSortOrder, getPendingAction, isPendingEntity, isPendingInteractionBlocked, makePendingMarkers, revealPendingFeedback, shouldShowPendingFeedback, stripPendingMarkers } from './optimistic';
...
export { isPendingEntity, getPendingAction, isPendingInteractionBlocked, shouldShowPendingFeedback, makePendingMarkers, revealPendingFeedback, getNextOptimisticSortOrder, stripPendingMarkers };
...
export declare function applyOptimisticCreate<T extends {
    id: string;
...
export declare function applyOptimisticUpdate<T extends {
    id: string;
...
export declare function applyOptimisticDelete<T extends {
    id: string;
...
export declare function getNextOptimisticSortOrderFromQueries<T extends {
...
export declare function confirmOptimisticUpdate(queryClient: QueryClient, queryKeyPrefix: QueryKey, entityId: string, options?: ConfirmOptimisticUpdateOptions): void;
export interface ConfirmOptimisticCreateOptions {
    serverEntity?: Record<string, unknown>;
    insertPosition?: 'prepend' | 'append';
}
export declare function confirmOptimisticCreate(queryClient: QueryClient, queryKeyPrefix: QueryKey, optimisticId: string, realId: string, options?: ConfirmOptimisticCreateOptions): void;
export declare function safeInvalidateQueries(queryClient: QueryClient, mutationKeyDomain: QueryKey, ...queryKeysToInvalidate: QueryKey[]): void;
export declare function safeInvalidateQueriesInactive(queryClient: QueryClient, mutationKeyDomain: QueryKey, ...queryKeysToInvalidate: QueryKey[]): void;
