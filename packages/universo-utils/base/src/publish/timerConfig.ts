const TIMER_POSITIONS = new Set(['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-right'] as const)

export type TimerPosition = typeof TIMER_POSITIONS extends Set<infer T> ? T : never
...
export const isValidTimerPosition = (position: unknown): position is TimerPosition => {
    return TIMER_POSITIONS.has(position as TimerPosition)
}

export const clampTimerSeconds = clampTimerLimitSeconds
