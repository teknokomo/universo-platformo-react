...
1. Verify initialization order in `packages/universo-core-backend/src/index.ts`:
...
2. Check lazy router mounting in `packages/universo-core-backend/src/routes/index.ts`:
