# @universo/flowise-leads-backend
...
- **Package**: `@universo/flowise-leads-backend`
- **Version**: `0.1.0`
- **Type**: Backend (Modern)
...
```bash
pnpm add @universo/flowise-leads-backend
```
...
import {
    ...
    Lead,
    leadsMigrations
} from '@universo/flowise-leads-backend'
...
```
packages/flowise-leads-backend/
├── base/
│   ├── src/
│   │   ├── database/
