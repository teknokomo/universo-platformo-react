# Фронтенд аутентификации (@universo/auth-frontend)
...
```tsx
import { AuthView } from '@universo/auth-frontend'
;<AuthView
    labels={{
...
```tsx
import { LoginForm } from '@universo/auth-frontend'
;<LoginForm
    client={authClient}
    labels={{
        submit: 'Войти',
...
pnpm --filter @universo/auth-frontend lint
```
...
-   [Бэкенд сервиса аутентификации](../auth-backend/README-RU.md)
-   [Пакет API-клиента](../universo-api-client/README-RU.md)
-   [Шаблон Material-UI](../universo-template-mui/README-RU.md)
