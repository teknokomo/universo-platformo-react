...
# Сборка пакета
pnpm --filter @universo/clusters-backend build
```
...
import { clustersRouter } from '@universo/clusters-backend'
...
### Настройка TypeORM
```typescript
import { getDataSource } from '@universo/clusters-backend/database'
import { Cluster, Domain, Resource } from '@universo/clusters-backend/resources'
...
import { clusterMigrations } from '@universo/clusters-backend/migrations'

// Регистрация сущностей в flowise-server
export * from '@universo/clusters-backend/resources'
```
...
## Связанные пакеты
- [`@universo/clusters-frontend`](../clusters-frontend/base/README.md) - Фронтенд клиент
