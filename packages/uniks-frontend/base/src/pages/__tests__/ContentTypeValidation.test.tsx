...
describe('Content-Type Validation', () => {
    describe('Response Structure Validation', () => {
        test('unik object should have required fields', () => {
            ...
            // Validate structure
            expect(mockUnik).toHaveProperty('id')
            expect(mockUnik).toHaveProperty('name')
            expect(mockUnik).toHaveProperty('description')
            expect(mockUnik).toHaveProperty('createdAt')
            expect(mockUnik).toHaveProperty('updatedAt')

            // Validate data types
            expect(typeof mockUnik.id).toBe('string')
            expect(typeof mockUnik.name).toBe('string')
            expect(typeof mockUnik.sectionsCount).toBe('number')
        })
