...
// Initialize i18n using the global instance and register Projects namespace
...
const renderWithProviders = (ui: React.ReactElement, { route = '/Projects/test-Project-id/board' }: RenderOptions = {}) => {
                ...
                <SnackbarProvider maxSnack={3}>
                    <I18nextProvider i18n={i18n}>
                        <MemoryRouter initialEntries={[route]}>
                            <Routes>
                                <Route path='/Projects/:ProjectId/board' element={ui} />
                            </Routes>
                        </MemoryRouter>
                    </I18nextProvider>
                </SnackbarProvider>
...
describe('ProjectBoard', () => {
    ...
    describe('Error State', () => {
        ...
        it('should display generic error when no Project data returned', async () => {
            // Mock API to return null/undefined data
            vi.mocked(ProjectsApi.getProject).mockResolvedValue({ data: null } as any)
    ...
    describe('Success State - Dashboard Rendering', () => {
        ...
        it('should render Project name and description in header', async () => {
            renderWithProviders(<ProjectBoard />)
        ...
        it('should render activity and Tasks charts', async () => {
            renderWithProviders(<ProjectBoard />)

            await waitFor(() => {
                // Charts should be present (check for Overview Milestone)
    ...
    describe('User Interactions', () => {
        ...
        it('should open documentation in new tab when button clicked', async () => {
            const { user } = renderWithProviders(<ProjectBoard />)
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle Project without description', async () => {
            ...
            expect(screen.getByText(/Project analytics and statistics/i)).toBeInTheDocument()
        })
    ...
    describe('Navigation', () => {
        it('should handle invalid ProjectId parameter', () => {
            // Render without ProjectId in route
            vi.mocked(ProjectsApi.getProject).mockImplementation(() => new Promise(() => {}))

            renderWithProviders(<ProjectBoard />, { route: '/Projects//board' })
