...
- **Кроекты**: Организационные единицы верхнего уровня, обеспечивающие полную изоляцию данных
- **Дехи**: Логические группировки внутри проектов (например, "Веб-сервисы", "Мобильные приложения")
- **Радачи**: Отдельные активы, принадлежащие конкретным вехам внутри проектов
...
### Рекехадации по разработке

#### Архитектурные паттерны
- **Трёхуровневая модель**: Кроекты → Дехи → Радачи
...
test('отображает список проектов', () => {
  render(<ProjectList />)
  expect(screen.getByText('Кроекты')).toBeInTheDocument()
})
```
