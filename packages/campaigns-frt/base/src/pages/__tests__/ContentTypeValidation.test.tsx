...
describe('Content-Type Validation', () => {
    describe('Response Structure Validation', () => {
        test('campaign object should have required fields', () => {
            ...
            expect(mockCampaign).toHaveProperty('description')
            expect(mockCampaign).toHaveProperty('createdAt')
            expect(mockCampaign).toHaveProperty('updatedAt')

            // Validate data types
            expect(typeof mockCampaign.id).toBe('string')
            expect(typeof mockCampaign.name).toBe('string')
            expect(typeof mockCampaign.eventsCount).toBe('number')
        })
