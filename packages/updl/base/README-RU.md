...
-   **Без построителей пространств**: Обрабатывается системой публикации (`publish-frontend`).
...
- [Фронтенд публикации](../publish-frontend/base/README-RU.md)
- [Построитель пространств](../space-builder-frontend/base/README-RU.md)
