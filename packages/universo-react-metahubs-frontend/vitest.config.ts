...
const coreFrontendSrcDir = path.resolve(__dirname, '../universo-react-core-frontend/src')
const templateMuiSrcDir = path.resolve(__dirname, '../universo-react-template-mui/src')
const utilsOptimisticCrudSrcFile = path.resolve(__dirname, '../universo-react-utils/src/optimisticCrud.ts')
const adminFrontendI18nDir = path.resolve(__dirname, '../universo-react-admin-frontend/src/i18n/index.ts')
const startFrontendI18nDir = path.resolve(__dirname, '../universo-react-start-frontend/src/i18n/index.ts')
const applicationsFrontendI18nDir = path.resolve(__dirname, '../universo-react-applications-frontend/src/i18n/index.ts')
...
export default mergeConfig(
    ...
    defineConfig({
        ...
        resolve: {
            alias: [
                {
                    find: '@universo-react/template-mui/dropdowns',
                    replacement: path.resolve(templateMuiSrcDir, 'components/dropdowns/index.ts')
                },
                {
                    find: '@universo-react/template-mui/components/dialogs',
                    replacement: path.resolve(templateMuiSrcDir, 'components/dialogs/index.ts')
                },
                {
                    find: '@universo-react/template-mui',
                ...
                {
                    find: '@universo-react/admin-frontend/i18n',
                    replacement: adminFrontendI18nDir
                },
                {
                    find: '@universo-react/start-frontend/i18n',
                    replacement: startFrontendI18nDir
                },
                {
                    find: '@universo-react/applications-frontend/i18n',
                    replacement: applicationsFrontendI18nDir
                },
                {
                    find: '@universo-react/metahubs-frontend',
