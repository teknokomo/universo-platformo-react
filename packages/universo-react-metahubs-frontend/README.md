...
-   **Package**: `@universo-react/metahubs-frontend`
-   **Version**: `0.1.0`
...
Route guard component that blocks navigation when metahub migrations are pending. Uses `MigrationGuardShell` from `@universo-react/migration-guard-shared` for shared guard logic.
...
-   [`@universo-react/template-mui`](../universo-react-template-mui/README.md) - UI components
-   [`@universo-react/types`](../universo-react-types/README.md) - Shared types
