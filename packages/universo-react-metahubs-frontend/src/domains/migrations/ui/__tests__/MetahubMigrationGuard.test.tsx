...
vi.mock('@universo-react/utils', async () => {
    const actual = await vi.importActual<typeof import('@universo-react/utils')>('@universo-react/utils')
    return {
        ...actual,
...
describe('MetahubMigrationGuard', () => {
    ...
    it('blocks non-migration routes when migration is required', () => {
        ...
        renderGuard('/metahub/019c4ea1-d889-705b-9798-1d28ba55a603/entities/object/instances')
