...
import type { MetahubTemplateManifest, VersionedLocalizedContent } from '@universo-react/types'
import { isPendingEntity, getPendingAction, type ConflictInfo } from '@universo-react/utils'
...
import { EntityFormDialog, ConfirmDeleteDialog, ConflictResolutionDialog } from '@universo-react/template-mui/components/dialogs'
