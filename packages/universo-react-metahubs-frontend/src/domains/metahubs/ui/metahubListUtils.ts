import type { ConflictInfo } from '@universo-react/utils'
import type { MetahubLocalizedPayload } from '../../../types'

export type MetahubFormValues = {
    nameVlc?: import('@universo-react/types').VersionedLocalizedContent<string> | null
    descriptionVlc?: import('@universo-react/types').VersionedLocalizedContent<string> | null
    codename?: import('@universo-react/types').VersionedLocalizedContent<string> | null
