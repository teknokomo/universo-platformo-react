...
import type { DragEndEvent } from '@universo-react/template-mui'
import { EntityFormDialog, ConflictResolutionDialog } from '@universo-react/template-mui/components/dialogs'
...
import { isEnabledCapabilityConfig, type VersionedLocalizedContent } from '@universo-react/types'
