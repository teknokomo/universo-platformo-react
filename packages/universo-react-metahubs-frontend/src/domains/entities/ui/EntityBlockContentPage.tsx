...
import { ConflictResolutionDialog } from '@universo-react/template-mui/components/dialogs'
import { isEnabledCapabilityConfig, normalizePageBlockContentForStorage, type PageBlockContent } from '@universo-react/types'
