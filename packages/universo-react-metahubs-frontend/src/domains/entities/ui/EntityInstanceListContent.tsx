...
import type { EntitySelectionLabels } from '@universo-react/template-mui'
import {
    APIEmptySVG,
    BaseEntityMenu,
    EmptyListState,
...
import { extractConflictInfo, isOptimisticLockConflict, type ConflictInfo } from '@universo-react/utils'
...
const EntityInstanceListContent = () => {
    ...
    const containerSelectionLabels = useMemo<Partial<EntitySelectionLabels>>(
        () => ({
            title:
                treeAssignmentTabId === 'hubs'
                    ? resolveTreeAssignmentLabel('title', 'hubs.title', 'Hubs')
                    : resolveTreeAssignmentLabel('title', 'entities.instances.tabs.containers', 'Containers'),
        ...
        [resolveTreeAssignmentLabel, t, treeAssignmentTabId]
    )
