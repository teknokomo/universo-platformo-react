...
import { resolveSharedBehavior, type SharedBehavior, type SharedEntityKind } from '@universo-react/types'
import { EntitySelectionPanel, type EntitySelectionLabels } from '@universo-react/template-mui'
