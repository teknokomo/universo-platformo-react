...
export { getVLCString, getVLCStringWithFallback, normalizeLocale } from '@universo-react/utils/vlc'
export type { SimpleLocalizedInput, VersatileLocalizedContent } from '@universo-react/utils/vlc'

// Import types for local use in entity interfaces and payloads
import type { SimpleLocalizedInput, VersatileLocalizedContent } from '@universo-react/utils/vlc'

// Re-export role type
export type { MetahubRole }

// Re-export conflict info for optimistic locking
export type { ConflictInfo } from '@universo-react/utils'

// ============ PAGINATION TYPES ============
// Re-export from @universo-react/types for consistency
export type { PaginationParams, PaginationMeta, PaginatedResponse } from '@universo-react/types'
export type {
    ComponentDefinitionDataType,
    FixedValueDataType,
...
export { getDefaultValidationRules, getPhysicalDataType, formatPhysicalType } from '@universo-react/types'
