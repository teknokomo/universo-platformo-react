...
const coreFrontendSrcDir = path.resolve(__dirname, '../universo-core-frontend/src')
...
const adminFrontendI18nDir = path.resolve(__dirname, '../admin-frontend/src/i18n/index.ts')
const startFrontendI18nDir = path.resolve(__dirname, '../start-frontend/src/i18n/index.ts')
const applicationsFrontendI18nDir = path.resolve(__dirname, '../applications-frontend/src/i18n/index.ts')
