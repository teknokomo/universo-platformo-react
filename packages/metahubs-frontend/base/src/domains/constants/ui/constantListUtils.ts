...
import type { Constant, ConstantDisplay } from '../../../types'
...
export const renderConstantValue = (row: ConstantDisplay, uiLocale: string, labels: { boolTrue: string; boolFalse: string }): string => {
