...
describe('Content-Type Validation', () => {
    describe('Response Structure Validation', () => {
        test('metahub object should have required fields', () => {
            ...
            // Validate structure
            expect(mockMetahub).toHaveProperty('id')
            expect(mockMetahub).toHaveProperty('name')
            expect(mockMetahub).toHaveProperty('description')
            expect(mockMetahub).toHaveProperty('createdAt')
            expect(mockMetahub).toHaveProperty('updatedAt')

            // Validate data types
            expect(typeof mockMetahub.id).toBe('string')
            expect(typeof mockMetahub.name).toBe('object')
            expect(typeof (mockMetahub.name as any).locales?.en?.content).toBe('string')
            expect(typeof mockMetahub.meta_sectionsCount).toBe('number')
        })
