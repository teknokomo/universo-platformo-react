    ...
    return (
        <Stack spacing={3}>
            <Alert severity="info" sx={{ mb: 1 }}>
                {t('publications.applications.createInfo', 'При создании Публикации можно автоматически создать связанное Приложение с Коннектором.')}
            </Alert>
                    ...
                    label={
                        <Box>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                {t('publications.applications.autoCreateDescription', 'Будет создано Приложение с Коннектором, связанным с текущим Метахабом')}
                            </Typography>
                        </Box>
                    }
                />
