...
export type FixedValueGeneralFieldsProps = {
...
export const FixedValueGeneralFields = ({
    values,
    setValue,
    isLoading,
    errors,
        ...
        <Stack spacing={2}>
            ...
            <FormControl fullWidth disabled={isLoading || dataTypeDisabled}>
                ...
                <Select
                    ...
                    value={dataType}
                    onChange={(event) => {
                        const nextType = event.target.value as FixedValueDataType
...
const ConstantFormFields = FixedValueGeneralFields
