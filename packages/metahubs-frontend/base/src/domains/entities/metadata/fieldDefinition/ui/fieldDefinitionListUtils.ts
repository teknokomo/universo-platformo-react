...
import type { FieldDefinitionDataType, FieldDefinitionValidationRules } from '../../../../../types'
...
export type CatalogTab = 'fieldDefinitions' | 'system' | 'records' | 'settings'
...
export type AttributeFormValues = {
    ...
    validationRules?: FieldDefinitionValidationRules
