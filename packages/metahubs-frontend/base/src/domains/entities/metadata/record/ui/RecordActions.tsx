...
import type { RecordItem, RecordItemDisplay } from '../../../../../types'
...
const elementActions: readonly ActionDescriptor<RecordItemDisplay, ElementData>[] = [
    {
        id: 'edit',
        ...
        onSelect: async (ctx) => {
            const helpers = ctx.helpers as
                | {
                      openEditDialog?: (entity: RecordItem | RecordItemDisplay) => void | Promise<void>
                  }
                | undefined
            const rawElement = (ctx as { rawElement?: RecordItem }).rawElement
    ...
    },
    {
        ...
        onSelect: async (ctx) => {
            const helpers = ctx.helpers as
                | {
                      openCopyDialog?: (entity: RecordItem | RecordItemDisplay) => void | Promise<void>
                  }
                | undefined
            const rawElement = (ctx as { rawElement?: RecordItem }).rawElement
    ...
    {
        id: 'move-up',
        labelKey: 'records.actions.moveUp',
    ...
    {
        id: 'move-down',
        labelKey: 'records.actions.moveDown',
