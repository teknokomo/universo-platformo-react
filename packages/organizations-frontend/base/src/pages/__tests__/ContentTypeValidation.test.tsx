...
describe('Content-Type Validation', () => {
    describe('Response Structure Validation', () => {
        test('organization object should have required fields', () => {
            ...
            // Validate structure
            expect(mockOrganization).toHaveProperty('id')
            expect(mockOrganization).toHaveProperty('name')
            expect(mockOrganization).toHaveProperty('description')
            expect(mockOrganization).toHaveProperty('createdAt')
            expect(mockOrganization).toHaveProperty('updatedAt')

            // Validate data types
            expect(typeof mockOrganization.id).toBe('string')
            expect(typeof mockOrganization.name).toBe('string')
            expect(typeof mockOrganization.departmentsCount).toBe('number')
        })
