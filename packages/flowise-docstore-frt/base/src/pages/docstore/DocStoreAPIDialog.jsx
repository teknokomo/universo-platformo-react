...
import { MemoizedReactMarkdown } from '@flowise/template-mui'
import { CodeBlock } from '@flowise/template-mui'
...
const DocStoreAPIDialog = ({ show, dialogProps, onCancel }) => {
    ...
    const getConfigApi = useApi((...args) => api.documentStore.getDocumentStoreConfig(...args))
