...
import { StatsCard } from '@flowise/template-mui'
    ...
    const component = show ? (
        ...
        >
            ...
            <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2, maxHeight: '75vh', position: 'relative', px: 3, pb: 3 }}>
                ...
                >
                    <StatsCard title={t('vector-store:upsertResult.added')} stat={dialogProps.numAdded ?? 0} />
                    <StatsCard title={t('vector-store:upsertResult.updated')} stat={dialogProps.numUpdated ?? 0} />
                    <StatsCard title={t('vector-store:upsertResult.skipped')} stat={dialogProps.numSkipped ?? 0} />
                    <StatsCard title={t('vector-store:upsertResult.deleted')} stat={dialogProps.numDeleted ?? 0} />
                </div>
                <div>
