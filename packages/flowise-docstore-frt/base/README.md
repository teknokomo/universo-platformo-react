...
import {
    ...
    AddDocStoreDialog,
    VectorStoreDialog
} from '@flowise/docstore-frt'
```

### Import i18n Resources

```jsx
import { registerDocstoreI18n } from '@flowise/docstore-frt/i18n'
...
import DocumentStore from '@flowise/docstore-frt/pages/docstore'

// Vector Store dialogs
import VectorStoreDialog from '@flowise/docstore-frt/pages/vectorstore/VectorStoreDialog'
```
...
- `@flowise/docstore-srv` - Backend service for document stores
...
- `packages/flowise-ui` - Main Flowise UI application
- `packages/spaces-frt` - Spaces management (via exports)
...
```jsx
// packages/flowise-ui/src/routes/MainRoutes.jsx
...
- `packages/flowise-server/src/routes/documentstore/`
- `packages/flowise-server/src/controllers/documentstore/`
