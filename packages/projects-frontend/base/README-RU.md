...
- **Пакет**: `@universo/projects-frontend`
- **Версия**: `0.1.0`
...
# Собрать пакет
pnpm --filter @universo/projects-frontend build

# Запустить в режиме разработки
pnpm --filter @universo/projects-frontend dev
```

### Интеграция
```tsx
// Импорт компонентов в ваше React-приложение
import { ProjectList, ProjectBoard, projectsDashboard } from '@universo/projects-frontend'

// Импорт i18n задач
import { projectsTranslations } from '@universo/projects-frontend'
...
### Базовые компоненты
```tsx
import { ProjectList, ProjectBoard } from '@universo/projects-frontend'
...
### Интеграция API
```tsx
import { useApi } from '@universo/projects-frontend/hooks'
import * as projectsApi from '@universo/projects-frontend/api'
...
### Интеграция меню
```tsx
import { projectsDashboard } from '@universo/projects-frontend'
...
```
packages/projects-frontend/base/
├── src/
...
```tsx
import { ProjectList } from '@universo/projects-frontend'
...
```tsx
import { ProjectBoard } from '@universo/projects-frontend'
...
import { projectsQueryKeys } from '@universo/projects-frontend/api'
...
## Связанные пакеты
- [`@universo/projects-backend`](../projects-backend/base/README.md) - Бэкенд сервис
