...
This package re-exports the shared store instance, legacy action and constant modules, and CASL/global-access React helpers that are still consumed by `@universo-react/core-frontend`.
...
-   `@universo-react/core-frontend` consumes this package directly.
