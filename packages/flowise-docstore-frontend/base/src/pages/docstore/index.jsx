...
// project imports
import { MainCard, DocumentStoreCard, StyledButton, ErrorBoundary, ViewHeaderMUI as ViewHeader } from '@flowise/template-mui'
...
import doc_store_empty from '@flowise/template-mui/assets/images/doc_store_empty.svg'
...
const Documents = () => {
    ...
    const getAllDocumentStores = useApi(() => api.documentStore.getAllDocumentStores(unikId))
            ...
            {error ? (
                ...
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    <ViewHeader
                        ...
                        search={true}
                        searchPlaceholder={t('document-store:searchPlaceholder')}
                        title={t('document-store:title')}
                    >
                        <ToggleButtonGroup
