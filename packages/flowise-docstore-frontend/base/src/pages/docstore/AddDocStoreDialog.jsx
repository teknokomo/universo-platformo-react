...
const AddDocStoreDialog = ({ show, dialogProps, onCancel, onConfirm }) => {
    ...
    const createDocumentStore = async () => {
        try {
            ...
            const createResp = await api.documentStore.createDocumentStore(dialogProps.unikId, obj)
            if (createResp.data) {
                enqueueSnackbar({
    ...
    const updateDocumentStore = async () => {
        try {
            ...
            const saveResp = await api.documentStore.updateDocumentStore(dialogProps.unikId, docStoreId, saveObj)
            if (saveResp.data) {
                enqueueSnackbar({
