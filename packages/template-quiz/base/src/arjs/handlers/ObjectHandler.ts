...
export class ObjectHandler {
    ...
    processMultiScene(multiScene: IUPDLMultiScene, options: BuildOptions = {}): string {
        try {
            // Processing multi-scene objects - detailed logs disabled for production
            ...
            multiScene.scenes.forEach((scene, sceneIndex) => {
                ...
                if (objects.length === 0) {
                    // No objects in scene - detailed logs disabled for production
                    return
                }
            ...
            // Multi-scene objects HTML generated - detailed logs disabled for production
            return content
        } catch (error) {
