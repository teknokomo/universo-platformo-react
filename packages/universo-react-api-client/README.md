...
The internal HTTP client is created through `@universo-react/auth-frontend`, so it is
...
-   [Auth Frontend](../universo-react-auth-frontend/README.md)
-   [REST Docs](../../universo-react-rest-docs/README.md)
