...
import { createLocalizedContent, filterLocalizedContent, getCodenamePrimary } from '@universo-react/utils'
import { CodenameField, LocalizedInlineField, useCodenameAutoFillVlc } from '@universo-react/template-mui'
import {
    sanitizeCodenameForStyle,
    normalizeCodenameForStyle,
    isValidCodenameForStyle,
    autoConvertMixedAlphabetsByFirstSymbol
} from '@universo-react/utils/validation/codename'
