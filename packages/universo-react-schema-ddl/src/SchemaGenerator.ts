...
import type { ComponentDefinitionValidationRules } from '@universo-react/types'
import { resolveApplicationLifecycleContractFromConfig, resolvePlatformSystemFieldsContractFromConfig } from '@universo-react/utils'
...
export class SchemaGenerator {
     ...
     * Delegates to shared getPhysicalDataType() from @universo-react/types.
