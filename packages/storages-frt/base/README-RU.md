...
import { clustersQueryKeys } from '@universo/storages-frt/api'
...
## Связанные пакеты
- [`@universo/storages-srv`](../storages-srv/base/README.md) - Бэкенд сервис
