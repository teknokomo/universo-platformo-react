...
describe('Content-Type Validation', () => {
    describe('Response Structure Validation', () => {
        test('storage object should have required fields', () => {
            ...
            // Validate structure
            expect(mockStorage).toHaveProperty('id')
            expect(mockStorage).toHaveProperty('name')
            expect(mockStorage).toHaveProperty('description')
            expect(mockStorage).toHaveProperty('createdAt')
            expect(mockStorage).toHaveProperty('updatedAt')

            // Validate data types
            expect(typeof mockStorage.id).toBe('string')
            expect(typeof mockStorage.name).toBe('string')
            expect(typeof mockStorage.containersCount).toBe('number')
        })
