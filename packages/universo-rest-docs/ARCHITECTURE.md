...
**Central Registry:** `packages/flowise-server/src/database/entities/index.ts`
...
**Migration Registration:** `packages/flowise-server/src/database/migrations/postgres/index.ts`
...
│   │   └── index.mjs   # ESM build
│   ├── package.json    # name: "@universo/new-feature-frt"
...
2. Export from central registry: `packages/flowise-server/src/database/entities/index.ts`
...
5. Import into central registry: `packages/flowise-server/src/database/migrations/postgres/index.ts`
...
import { SpaceService } from '@universo/spaces-srv';
...
import { SpaceService } from '../../spaces-srv/base/src/services';
```
