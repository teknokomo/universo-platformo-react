...
const { adminSystemAppDefinition } = require('@universo-react/admin-backend/platform-definition') as {
    adminSystemAppDefinition: SystemAppDefinition
}

const { profileSystemAppDefinition } = require('@universo-react/profile-backend/platform-definition') as {
    profileSystemAppDefinition: SystemAppDefinition
}

const { metahubsSystemAppDefinition } = require('@universo-react/metahubs-backend/platform-definition') as {
    metahubsSystemAppDefinition: SystemAppDefinition
}

const { applicationsSystemAppDefinition } = require('@universo-react/applications-backend/platform-definition') as {
...
export const publicSystemAppDefinition: SystemAppDefinition = {
    ...
    key: 'public',
    displayName: 'Public',
    ownerPackage: '@universo-react/migrations-platform',
    engineVersion: '0.1.0',
