...
describe('runtime cell mutation helpers', () => {
    ...
    it('tracks concurrent pending checkbox mutations per application', async () => {
        ...
        let mutateApp1: ((params: { rowId: string; field: string; value: boolean | null; catalogId?: string }) => void) | undefined
        let mutateApp2: ((params: { rowId: string; field: string; value: boolean | null; catalogId?: string }) => void) | undefined
