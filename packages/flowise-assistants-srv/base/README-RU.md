# @universo/flowise-assistants-srv
...
```bash
pnpm add @universo/flowise-assistants-srv
```
...
} from '@universo/flowise-assistants-srv'
...
- `@universo/uniks-srv` - Связь с сущностью Unik
- `@universo/flowise-credentials-srv` - Сущность Credential для OpenAI
