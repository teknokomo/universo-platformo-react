...
```tsx
import { usePublicationLinks, useCreateGroupLink, useDeleteLink } from '@universo/publish-frontend/hooks/publication'
...
```tsx
import { usePublicationSettings } from '@universo/publish-frontend/hooks/publication'
...
```tsx
import { useCanvasData, useVersionGroupId } from '@universo/publish-frontend/hooks/publication'
...
```tsx
import { useVersionResolution } from '@universo/publish-frontend/hooks/publication'
...
```tsx
import { usePublicationState } from '@universo/publish-frontend/hooks/publication'
