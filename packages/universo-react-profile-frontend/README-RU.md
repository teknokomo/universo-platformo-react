...
# Сборка пакета
pnpm --filter @universo-react/profile-frontend build
```
...
```tsx
import { ProfilePage } from '@universo-react/profile-frontend'
...
pnpm --filter @universo-react/profile-frontend dev

# В другом терминале, запуск тестов
pnpm --filter @universo-react/profile-frontend test
...
-   [`@universo-react/profile-backend`](../universo-react-profile-backend/README-RU.md) - Бэкенд сервис профилей
-   [`@universo-react/auth-frontend`](../universo-react-auth-frontend/README-RU.md) - Фронтенд аутентификации
-   [`@universo-react/i18n`](../universo-react-i18n/README-RU.md) - Интернационализация
