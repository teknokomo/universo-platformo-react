...
-   `@universo-react/database` owns Knex runtime lifecycle and executor factories.
-   `@universo-react/types` provides shared domain and enum contracts.
-   Backend packages consume `@universo-react/utils/database` as the neutral SQL-first seam.
