 ...
 *
 * Implements INodeProvider interface from @flowise/docstore-srv
 * by wrapping nodesPool from the running Express app.
 */

import type { INodeProvider, INodeMetadata, ICredentialMetadata, INodeInputParam } from '@flowise/docstore-srv'
