...
-   `@universo-react/core-backend` монтирует этот feature-пакет в основной сервер.
-   `@universo-react/start-frontend` использует backend-потоки, которые здесь публикуются.
