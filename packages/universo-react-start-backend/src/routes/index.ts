...
import type { AssignSystemRole } from '@universo-react/types'
 ...
 */
export function createStartServiceRoutes(
    ...
    router.use('/onboarding', createOnboardingRoutes(ensureAuth, getRequestDbExecutor, read, write, assignSystemRole))
