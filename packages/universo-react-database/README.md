...
-   [@universo-react/utils](../universo-react-utils/README.md)

## Related Packages

-   `@universo-react/core-backend` uses this package as the backend runtime database entry point.
...
-   `@universo-react/utils` complements this package with neutral query and transaction helper contracts.
