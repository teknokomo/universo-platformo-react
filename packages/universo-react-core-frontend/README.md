...
✅ **Modern Package** — `@universo-react/core-frontend`
...
-   **Authentication**: `@universo-react/auth-frontend` — login, session, protected routes
-   **Profile**: `@universo-react/profile-frontend` — user profile management
-   **Applications**: `@universo-react/applications-frontend` — application CRUD
-   **Metahubs**: `@universo-react/metahubs-frontend` — metadata hub management
-   **API Client**: `@universo-react/api-client` — centralized Axios-based API layer
-   **UI Components**: `@universo-react/template-mui` — shared MUI theme, layout, navigation
...
The `@/` prefix resolves to `src/` directory. All workspace package imports use `@universo-react/` scope via PNPM workspace resolution.
...
-   [universo-core-backend](../universo-react-core-backend/README.md) — Express backend server
-   [universo-template-mui](../universo-react-template-mui/README.md) — Shared UI components and theme
-   [universo-i18n](../universo-react-i18n/README.md) — Internationalization system
-   [auth-frontend](../universo-react-auth-frontend/README.md) — Authentication UI
