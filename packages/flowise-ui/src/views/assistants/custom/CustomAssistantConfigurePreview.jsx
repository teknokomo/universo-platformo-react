...
const CustomAssistantConfigurePreview = () => {
    ...
    const getDocStoresApi = useApi(api.assistants.getDocStores)
    const getToolsApi = useApi(api.assistants.getTools)
    const getCanvasApi = useApi(api.canvases.getCanvas)
        ...
        if (checkMandatoryFields()) {
            ...
            try {
                ...
                if (saveResp.data) {
                    ...
                    const saveAssistantResp = await api.assistants.updateAssistant(unikId, customAssistantId, {
    ...
    const handleDeleteFlow = async () => {
        ...
        if (isConfirmed && customAssistantId) {
            try {
                const resp = await api.assistants.deleteAssistant(unikId, customAssistantId)
