...
const embedPopupHtmlCode = (canvasId) => {
...
const embedPopupReactCode = (canvasId) => {
...
const embedFullpageHtmlCode = (canvasId) => {
...
const embedFullpageReactCode = (canvasId) => {
...
const embedPopupHtmlCodeCustomization = (canvasId) => {
    return `<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/flowise-embed/dist/web.js"
    Chatbot.init({
        canvasId: "${canvasId}",
...
const embedPopupReactCodeCustomization = (canvasId) => {
    return `import { BubbleChat } from 'flowise-embed-react'
...
const embedFullpageHtmlCodeCustomization = (canvasId) => {
    return `<flowise-fullchatbot></flowise-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/flowise-embed/dist/web.js"
    Chatbot.initFull({
...
const embedFullpageReactCodeCustomization = (canvasId) => {
    return `import { FullPageChat } from 'flowise-embed-react'
...
const EmbedChat = ({ canvasId }) => {
    ...
    const getCode = (codeLang) => {
        switch (codeLang) {
            case 'Popup Html':
                return embedPopupHtmlCode(canvasId)
            case 'Fullpage Html':
                return embedFullpageHtmlCode(canvasId)
            case 'Popup React':
                return embedPopupReactCode(canvasId)
            case 'Fullpage React':
                return embedFullpageReactCode(canvasId)
            default:
                return ''
        }
    }
    ...
    const getCodeCustomization = (codeLang) => {
        switch (codeLang) {
            case 'Popup Html':
                return embedPopupHtmlCodeCustomization(canvasId)
            case 'Fullpage Html':
                return embedFullpageHtmlCodeCustomization(canvasId)
            case 'Popup React':
                return embedPopupReactCodeCustomization(canvasId)
            case 'Fullpage React':
                return embedFullpageReactCodeCustomization(canvasId)
            default:
                return embedPopupHtmlCodeCustomization(canvasId)
        }
    }
