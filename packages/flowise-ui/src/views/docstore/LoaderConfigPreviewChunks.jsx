...
// import { api } from '@universo/api-client' // Replaced import documentsApi from '@/api/documentstore' // Duplicate removed
...
const LoaderConfigPreviewChunks = () => {
    ...
    const getNodeDetailsApi = useApi(api.nodes.getSpecificNode)
    const getNodesByCategoryApi = useApi(api.nodes.getNodesByCategory)
