...
import VariablesEmptySVG from '@flowise/template-mui/assets/images/variables_empty.svg'
...
const Variables = () => {
    ...
    const getAllVariables = useApi(() => api.variables.getAllVariables(unikId))
                                            ...
                                            <>
                                                {variables.filter(filterVariables).map((variable, index) => (
                                                    <StyledTableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                        ...
                                                        <StyledTableCell>
                                                            {dayjs(variable.updatedDate).format('MMMM Do, YYYY HH:mm:ss')}
                                                        </StyledTableCell>
                                                        <StyledTableCell>
                                                            {dayjs(variable.createdDate).format('MMMM Do, YYYY HH:mm:ss')}
                                                        </StyledTableCell>
                                                        <StyledTableCell>
