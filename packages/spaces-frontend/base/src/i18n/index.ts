...
// Register spaces-frontend namespaces with global i18n instance
...
// We only register canvas namespace here for spaces-frontend specific translations

// Register canvas namespace for spaces-frontend
