...
import { useSpacesQuery } from '@universo/spaces-frontend'

// API
import { api } from '@universo/api-client'

// Hooks - use TypeScript version from spaces-frontend package
import useApi from '@universo/spaces-frontend/src/hooks/useApi'
