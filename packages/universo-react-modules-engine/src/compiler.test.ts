...
const VALID_SOURCE = `import { ExtensionModule, AtClient, AtServer } from '@universo-react/extension-sdk'
...
const SERVER_AND_CLIENT_SOURCE = `import { ExtensionModule, AtServerAndClient } from '@universo-react/extension-sdk'
...
const POSTING_LIFECYCLE_SOURCE = `import { ExtensionModule, OnEvent } from '@universo-react/extension-sdk'
...
const SAFE_SERVER_ONLY_QUIZ_SOURCE = `import { ExtensionModule, AtClient, AtServer } from '@universo-react/extension-sdk'
...
const VALID_LIBRARY_SOURCE = `import { SharedLibraryModule } from '@universo-react/extension-sdk'
...
describe('compileModuleSource', () => {
    ...
    it('rejects dynamic import expressions', async () => {
        await expect(
            compileModuleSource(
                createInput(`import { ExtensionModule, AtClient } from '@universo-react/extension-sdk'
...
`)
    ...
    it('rejects top-level runtime bindings shared by client and server methods', async () => {
        await expect(
            compileModuleSource(
                createInput(`import { ExtensionModule, AtClient, AtServer } from '@universo-react/extension-sdk'
...
`,
    ...
    it('rejects library modules that use runtime decorators', async () => {
        await expect(
            compileModuleSource(
                createLibraryInput(`import { SharedLibraryModule, AtServer } from '@universo-react/extension-sdk'
...
`)
    ...
    it('rejects library modules that access runtime ctx state', async () => {
        await expect(
            compileModuleSource(
                createLibraryInput(`import { SharedLibraryModule } from '@universo-react/extension-sdk'
