...
import { AGENTFLOW_ICONS } from '@flowise/template-mui/constants'
...
export const ExecutionDetails = ({ open, isPublic, execution, metadata, onClose, onProceedSuccess, onUpdateSharing, onRefresh }) => {
    ...
    const updateExecutionApi = useApi((executionId, payload) =>
        isCanvasScoped
            ? api.executions.updateExecution(unikId, spaceId, canvasId, executionId, payload)
            : api.executions.updateUnikExecution(unikId, executionId, payload)
    )
