# @universo/flowise-apikey-frontend
...
- **Package**: `@universo/flowise-apikey-frontend`
- **Version**: `0.1.0`
...
```bash
pnpm add @universo/flowise-apikey-frontend
```

## Usage

```jsx
import { APIKeyPage } from '@universo/flowise-apikey-frontend'
...
import '@universo/flowise-apikey-frontend/i18n'
```
...
```
packages/flowise-apikey-frontend/
├── base/
│   ├── src/
│   │   ├── pages/
