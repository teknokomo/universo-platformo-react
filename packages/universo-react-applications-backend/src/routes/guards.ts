import { activeAppRowCondition, type DbExecutor } from '@universo-react/utils'
import * as httpErrors from 'http-errors'
import { createAccessGuards } from '@universo-react/auth-backend'
import { isSuperuser, getGlobalRoleCodename, hasSubjectPermission } from '@universo-react/admin-backend'
import { applicationRolePolicySettingsSchema, type RoleCapabilityRule, type WorkflowCapabilityMap } from '@universo-react/types'
