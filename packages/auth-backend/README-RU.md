...
Производственный сервис аутентификации для серверной аутентификации Universo Platformo. Построен на Passport.js + Supabase и монтируется внутри `packages/universo-core-backend` по пути `/api/v1/auth`.
...
Используется из `packages/universo-core-backend`.
...
-   [Фронтенд аутентификации](../auth-frontend/README-RU.md)
-   [RLS Integration Pattern](../../../memory-bank/rls-integration-pattern.md)
-   [Интеграция с core backend](../universo-core-backend/README-RU.md)
