...
Production-grade authentication service powering Universo Platformo's server-side authentication. Built with Passport.js + Supabase and mounted inside `packages/universo-core-backend` at `/api/v1/auth`.
...
Consumed by `packages/universo-core-backend`.
...
-   [Authentication Frontend](../auth-frontend/README.md)
-   [RLS Integration Pattern](../../../memory-bank/rls-integration-pattern.md)
-   [Core Backend Integration](../universo-core-backend/README.md)
