export const SHARED_OBJECT_KINDS = {
    SHARED_OBJECT_POOL: 'shared-object-pool',
...
export const SHARED_ENTITY_KINDS = ['component', 'constant', 'value'] as const
