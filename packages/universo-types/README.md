...
This package lives at `packages/universo-types` and is consumed via `workspace:*` by other packages in the monorepo.
...
-   [Core Backend](../universo-core-backend/README.md)
-   [Core Frontend](../universo-core-frontend/README.md)
