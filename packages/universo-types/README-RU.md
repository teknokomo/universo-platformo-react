...
Пакет расположен по пути `packages/universo-types` и подключается другими пакетами монорепозитория через `workspace:*`.
...
-   [Core Backend](../universo-core-backend/README-RU.md)
-   [Core Frontend](../universo-core-frontend/README-RU.md)
