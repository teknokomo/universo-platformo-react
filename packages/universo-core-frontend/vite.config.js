...
const backendRootDir = resolve(__dirname, '../universo-core-backend')
    ...
    return {
        ...
        resolve: {
            ...
            alias: [
                ...
                { find: /^@universo\/utils$/, replacement: resolve(__dirname, '../universo-utils/src/index.browser.ts') },
                { find: /^@universo\/utils\/env$/, replacement: resolve(__dirname, '../universo-utils/src/env/index.browser.ts') },
                {
                    find: /^@universo\/utils\/validation\/codename$/,
                    replacement: resolve(__dirname, '../universo-utils/src/validation/codename.ts')
                },
                { find: /^@universo\/utils\/vlc$/, replacement: resolve(__dirname, '../universo-utils/src/vlc/index.ts') },
                {
                    find: /^@universo\/utils\/optimistic-crud$/,
                    replacement: resolve(__dirname, '../universo-utils/src/optimisticCrud.ts')
                }
            ]
        },
