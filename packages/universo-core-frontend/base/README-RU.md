...
- [universo-core-backend](../../universo-core-backend/base/README-RU.md) — Express бэкенд-сервер
- [universo-template-mui](../../universo-template-mui/base/README-RU.md) — Общие UI компоненты и тема
- [universo-i18n](../../universo-i18n/base/README-RU.md) — Система интернационализации
- [auth-frontend](../../auth-frontend/base/README-RU.md) — UI аутентификации
