...
-   [universo-core-backend](../universo-core-backend/README.md) — Express backend server
-   [universo-template-mui](../universo-template-mui/README.md) — Shared UI components and theme
-   [universo-i18n](../universo-i18n/README.md) — Internationalization system
-   [auth-frontend](../auth-frontend/README.md) — Authentication UI
