...
-   [universo-core-backend](../universo-core-backend/README-RU.md) — Express бэкенд-сервер
-   [universo-template-mui](../universo-template-mui/README-RU.md) — Общие UI компоненты и тема
-   [universo-i18n](../universo-i18n/README-RU.md) — Система интернационализации
-   [auth-frontend](../auth-frontend/README-RU.md) — UI аутентификации
