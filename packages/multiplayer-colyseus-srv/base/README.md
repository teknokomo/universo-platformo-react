# @universo/multiplayer-colyseus-srv
...
# Build the package
pnpm --filter @universo/multiplayer-colyseus-srv build
```
...
pnpm --filter @universo/multiplayer-colyseus-srv start
```
...
# Run with coverage
pnpm --filter @universo/multiplayer-colyseus-srv test -- --coverage
...
- [`@universo/spaces-frt`](../spaces-frt/base/README.md) - Space management frontend
