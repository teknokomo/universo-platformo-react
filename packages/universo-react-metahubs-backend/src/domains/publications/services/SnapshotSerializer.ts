    ...
    async serializeMetahub(
        ...
        const publishedModules = this.modulesService
            ? (await this.modulesService.listPublishedModules(metahubId)).map<MetahubSnapshotModule>((module) => ({
                  ...
                  sourceCode: module.sourceCode ?? undefined,
                  sourceStorage: module.sourceStorage,
        ...
        for (const hub of hubs) {
            ...
            const hubName = hub.name as unknown as import('@universo-react/types').VersionedLocalizedContent<string>
            const hubDescription = hub.description as unknown as import('@universo-react/types').VersionedLocalizedContent<string>
