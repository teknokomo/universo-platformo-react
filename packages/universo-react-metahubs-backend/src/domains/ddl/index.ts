/**
 * DDL Domain - Re-exports from @universo-react/schema-ddl with the shared database runtime.
 *
 * This module provides pre-configured DDL services using the shared Knex singleton
 * from @universo-react/database. For pure functions and types, import directly from
...
import { hasRuntimeHistoryTable as _hasRuntimeHistoryTable } from '@universo-react/migrations-core'
...
// Re-export types from @universo-react/schema-ddl
export type {
    EntityDefinition,
    Component,
