import { CodenameVLCSchema, type CodenameVLC, type VersionedLocalizedContent } from '@universo-react/types'
import {
    createCodenameVLC,
    ensureCodenameVLC,
    getCodenamePrimary,
...
import { normalizeCodenameVLCAllLocales } from '@universo-react/utils/validation/codename'
