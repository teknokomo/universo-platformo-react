 ...
 * avoiding entity class imports from @universo-react/applications-backend.
 * Used by metahubs-backend routes that need to read/write Application,
 * Connector, and ConnectorPublication records.
 */
import type { VersionedLocalizedContent, ApplicationSchemaStatus } from '@universo-react/types'
