...
-   Использовать канонические контракты блоков из `@universo-react/types`, а не определять локальные форматы хранения.
...
-   `@universo-react/types` владеет каноническими контрактами блочного контента и валидацией.
-   `@universo-react/template-mui` реэкспортирует пакет для административных сценариев авторинга.
-   `@universo-react/apps-template-mui` использует пакет напрямую в опубликованных приложениях.
