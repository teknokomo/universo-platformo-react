...
// Re-export admin config utilities from @universo-react/utils for convenience
export { isAdminPanelEnabled, isGlobalAdminEnabled, getAdminConfig, type AdminConfig } from '@universo-react/utils'
