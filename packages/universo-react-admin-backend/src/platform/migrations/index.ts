...
export const addAdminShellPermissionMigrationDefinition: SqlMigrationDefinition = {
    id: 'AddAdminShellPermission1733400000003',
    version: '1733400000003',
    summary: 'Add the admin shell permission predicate for capabilities whose management surface lives inside the admin shell',
    up: [
        {
            sql: `
...
END $$;
    ...
    down: [{ sql: `DROP FUNCTION IF EXISTS admin.has_admin_shell_permission(UUID)` }] as const
}
