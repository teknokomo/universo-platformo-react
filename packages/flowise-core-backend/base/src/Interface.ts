...
// Message type - compatible with @flowise/chatmessage-backend
export type MessageType = 'apiMessage' | 'userMessage'

// Chat type enum - compatible with @flowise/chatmessage-backend
export enum ChatType {
    INTERNAL = 'INTERNAL',
    EXTERNAL = 'EXTERNAL'
}

// Chat message rating type - compatible with @flowise/chatmessage-backend
...
// IAssistant moved to @flowise/assistants-backend (re-exported above)
...
// ILead re-exported from @flowise/leads-backend for backward compatibility
...
// DocumentStore related - re-export from @flowise/docstore-backend
import type {
