# @universo/organizations-backend
...
# Build the package
pnpm --filter @universo/organizations-backend build
```
...
import { organizationsRouter } from '@universo/organizations-backend'
...
### TypeORM Setup
```typescript
import { getDataSource } from '@universo/organizations-backend/database'
import { Organization, Department, Position } from '@universo/organizations-backend/entities'
...
import { clusterMigrations } from '@universo/organizations-backend/migrations'

// Position registration in flowise-server
export * from '@universo/organizations-backend/positions'
```
...
## Related Packages
- [`@universo/organizations-frontend`](../organizations-frontend/base/README.md) - Frontend client
