...
describe('Content-Type Validation', () => {
    describe('Response Structure Validation', () => {
        test('application object should have required fields', () => {
            ...
            expect(mockApplication).toHaveProperty('name')
            expect(mockApplication).toHaveProperty('description')
            expect(mockApplication).toHaveProperty('createdAt')
            expect(mockApplication).toHaveProperty('updatedAt')

            // Validate data types
            expect(typeof mockApplication.id).toBe('string')
            expect(typeof mockApplication.name).toBe('object')
            expect(typeof (mockApplication.name as any).locales?.en?.content).toBe('string')
            expect(typeof mockApplication.meta_sectionsCount).toBe('number')
        })
