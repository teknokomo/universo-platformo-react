...
type TemplateMuiModule = typeof import('@universo-react/template-mui')
type NotistackModule = typeof import('notistack')
type UtilsModule = typeof import('@universo-react/utils')
type MockHttpError = {
    message?: string
    response?: {
        status?: number
...
vi.mock('@universo-react/template-mui', async () => {
    const actual = await vi.importActual<TemplateMuiModule>('@universo-react/template-mui')
    return {
        ...actual,
...
vi.mock('@universo-react/utils', async () => {
    const actual = await vi.importActual<UtilsModule>('@universo-react/utils')
    return {
        ...actual,
