...
import { createLocalizedContent, filterLocalizedContent, updateLocalizedContentLocale } from '@universo-react/utils'

// Re-export centralized VLC utilities
export { normalizeLocale, getSimpleLocalizedValue, type SimpleLocalizedInput } from '@universo-react/utils/vlc'
import { normalizeLocale as normalizeLocaleCode } from '@universo-react/utils/vlc'

import type { SimpleLocalizedInput } from '@universo-react/utils/vlc'
