...
Компонент-гард маршрутов, который блокирует навигацию при необходимости обновления рантайм-схемы приложения. Использует `MigrationGuardShell` из `@universo-react/migration-guard-shared` для общей логики гарда.

```tsx
import { ApplicationMigrationGuard } from '@universo-react/applications-frontend'
