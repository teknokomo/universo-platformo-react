...
// Vitest coverage writes temporary files into coverage/.tmp during the frontend suite.
// Keep the directory available so coverage runs do not fail on a clean workspace.
