...
Route guard component that blocks navigation when the application runtime schema requires updates. Uses `MigrationGuardShell` from `@universo-react/migration-guard-shared` for shared guard logic.
