...
- **Package**: `@universo/storages-frontend`
- **Version**: `0.1.0`
...
import { storagesQueryKeys } from '@universo/storages-frontend/api'
...
## Related Packages
- [`@universo/storages-backend`](../Storages-backend/base/README.md) - Backend service
