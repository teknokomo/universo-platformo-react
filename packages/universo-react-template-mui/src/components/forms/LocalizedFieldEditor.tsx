...
import type { VersionedLocalizedContent, LocaleCode } from '@universo-react/types'
import { updateLocalizedContentLocale, getLocalizedContentLocales, createLocalizedContent } from '@universo-react/utils'
