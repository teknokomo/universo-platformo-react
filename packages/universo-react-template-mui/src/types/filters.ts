 ...
 * re-exported from @universo-react/types for consistency across the monorepo.
 *
 * MUI-specific component props are defined here.
 */

// Re-export core filter types from canonical source
export type { FilterType, FilterOption, FilterConfig, FilterValues } from '@universo-react/types'

// Import for use in local interface
import type { FilterConfig, FilterValues } from '@universo-react/types'
