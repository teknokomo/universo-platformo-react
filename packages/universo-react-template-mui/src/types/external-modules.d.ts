...
declare module '@universo-react/uniks-frontend/pages/UnikList' {
    import type { ComponentType } from 'react'
    const Component: ComponentType<Record<string, unknown>>
    export default Component
}

declare module '@universo-react/profile-frontend/pages/Profile.jsx' {
    import type { ComponentType } from 'react'
    const Component: ComponentType<Record<string, unknown>>
    export default Component
}

declare module '@universo-react/metaverses-frontend/pages/MetaverseList' {
    import type { ComponentType } from 'react'
    const Component: ComponentType<Record<string, unknown>>
    export default Component
}

declare module '@universo-react/metaverses-frontend/pages/MetaverseBoard' {
    import type { ComponentType } from 'react'
    const Component: ComponentType<Record<string, unknown>>
    export default Component
}

declare module '@universo-react/metaverses-frontend' {
    import type { ComponentType } from 'react'
    type GenericComponent = ComponentType<Record<string, unknown>>
...
declare module '@universo-react/resources-frontend' {
    import type { ComponentType } from 'react'
    export const ClusterList: ComponentType<Record<string, unknown>>
}

declare module '@universo-react/metahubs-frontend' {
    import type { ComponentType } from 'react'
    type GenericComponent = ComponentType<Record<string, unknown>>
