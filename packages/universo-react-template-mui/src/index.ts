...
// Minimal baseline exports for @universo-react/template-mui after reset
...
export const TemplateProvider = ({ children }: { children?: ReactNode }) => children
...
export type {
    ...
    LocalizedVariantTabItem,
    LocalizedVariantTabsLabels,
...
// Re-export dialogs (EntityFormDialog, ConfirmDialog, etc.) so consumers can import from '@universo-react/template-mui'
...
export type { PendingAction, PendingMarkers, MaybePending, SortOrderLike } from '@universo-react/utils'
