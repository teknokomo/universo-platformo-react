...
jest.mock('../bootstrap/startupReset', () => ({
...
jest.mock('@universo-react/auth-backend', () => ({
    ...
    createAccessGuards: jest.fn(() => ({
        assertPermission: jest.fn(),
        ensureAccess: jest.fn(),
        getMembershipSafe: jest.fn(),
...
jest.mock('@universo-react/migrations-platform', () => ({
...
jest.mock('@universo-react/utils', () => {
    const actual = jest.requireActual('@universo-react/utils')
