...
Основной бекенд-сервер Universo Platformo (бывший `flowise-server`), предоставляющий API эндпоинты, управление базой данных и бизнес-логику.
...
Основное React фронтенд-приложение (бывший `flowise-ui`) с интерфейсом визуального программирования.
