...
describe('Content-Type Validation', () => {
    describe('Response Structure Validation', () => {
        test('cluster object should have required fields', () => {
            ...
            // Validate structure
            expect(mockCluster).toHaveProperty('id')
            expect(mockCluster).toHaveProperty('name')
            expect(mockCluster).toHaveProperty('description')
            expect(mockCluster).toHaveProperty('createdAt')
            expect(mockCluster).toHaveProperty('updatedAt')

            // Validate data types
            expect(typeof mockCluster.id).toBe('string')
            expect(typeof mockCluster.name).toBe('string')
            expect(typeof mockCluster.domainsCount).toBe('number')
        })
