/**
 * MSW (Mock Service Worker) handlers for metaverses API
 *
 ...
 */
export const mockMetaverseData = {
...
export const mockMetaversesList = [
    {
        id: 'metaverse-1',
...
export const handlers = [
    // Get single metaverse
    http.get(`${API_BASE_URL}/metaverses/:id`, async ({ params }) => {
        await delay(50) // Simulate network delay

        const { id } = params

        if (id === 'not-found') {
            return HttpResponse.json({ message: 'Metaverse not found' }, { status: 404 })
        }
    ...
    // List metaverses
    http.get(`${API_BASE_URL}/metaverses`, async ({ request }) => {
        await delay(50)
        ...
        let filteredData = [...mockMetaversesList]
    ...
    // List sections
    http.get(`${API_BASE_URL}/metaverses/:metaverseId/sections`, async ({ request }) => {
        await delay(50)
    ...
    // List entities
    http.get(`${API_BASE_URL}/metaverses/:metaverseId/sections/:sectionId/entities`, async ({ request }) => {
        await delay(50)
    ...
    // List metaverse members
    http.get(`${API_BASE_URL}/metaverses/:metaverseId/members`, async ({ request }) => {
        await delay(50)
    ...
    // XSS Test: Metaverse with HTML-encoded malicious content for safe testing
    // Tests should verify that this encoded content is NOT executed and displays as text
    http.get(`${API_BASE_URL}/metaverses/xss-test`, async () => {
        await delay(50)
...
export const errorHandlers = {
    networkError: http.get(`${API_BASE_URL}/metaverses/:id`, () => {
        return HttpResponse.error()
    }),

    timeout: http.get(`${API_BASE_URL}/metaverses/:id`, async () => {
        ...
        await delay(4000)
        return HttpResponse.json({ data: mockMetaverseData })
    }),

    unauthorized: http.get(`${API_BASE_URL}/metaverses/:id`, () => {
        return HttpResponse.json({ message: 'Unauthorized' }, { status: 401 })
    }),

    forbidden: http.get(`${API_BASE_URL}/metaverses/:id`, () => {
