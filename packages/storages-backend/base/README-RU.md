...
# Сборка пакета
pnpm --filter @universo/storages-backend build
```
...
import { storagesRouter } from '@universo/storages-backend'
...
### Настройка TypeORM
```typescript
import { getDataSource } from '@universo/storages-backend/database'
import { storage, container, slot } from '@universo/storages-backend/slots'
...
import { clusterMigrations } from '@universo/storages-backend/migrations'

// Регистрация сущностей в flowise-server
export * from '@universo/storages-backend/slots'
```
...
## Связанные пакеты
- [`@universo/storages-frontend`](../storages-frontend/base/README.md) - Фронтенд клиент
