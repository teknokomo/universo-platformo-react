...
-   `@universo-react/core-frontend` может встраивать этот пакет в общую application shell.
-   `@universo-react/start-backend` предоставляет backend-потоки, которые потребляет этот frontend-модуль.
