 ...
 * via the i18n/index.ts module using registerNamespace() from @universo-react/i18n/registry.
 * Components should simply use `useTranslation('namespace')` from @universo-react/i18n.
 */
