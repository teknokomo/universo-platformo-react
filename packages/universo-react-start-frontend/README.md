...
-   `@universo-react/core-frontend` can embed this package inside the shared application shell.
-   `@universo-react/start-backend` provides the backend flows consumed by this frontend module.
