# Фронтенд аналитики (@universo/analytics-frontend)
...
### Автономный импорт
```typescript
import { AnalyticsPage } from '@universo/analytics-frontend'

// С утилитами переводов
import { analyticsTranslations, getAnalyticsTranslations } from '@universo/analytics-frontend/i18n'
```
...
# Сборка пакета
pnpm --filter @universo/analytics-frontend build

# Режим разработки с горячей перезагрузкой
pnpm --filter @universo/analytics-frontend dev

# Запуск тестов
pnpm --filter @universo/analytics-frontend test

# Проверка кода
pnpm --filter @universo/analytics-frontend lint
```
...
- [Пакет фронтенда пространств](../../spaces-frontend/base/README.md)
