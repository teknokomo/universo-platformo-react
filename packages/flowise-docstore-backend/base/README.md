...
This package contains **only the CRUD operations** that can be cleanly isolated. Complex operations that require runtime dependencies remain in `packages/flowise-core-backend/base/src/services/documentstore/`.

### What's in this package (@flowise/docstore-backend)
...
```typescript
// packages/flowise-core-backend/base/src/services/docstore-integration/index.ts
import { createDocumentStoreService } from '@flowise/docstore-backend'
...
```typescript
// packages/flowise-core-backend/base/src/services/documentstore/index.ts
