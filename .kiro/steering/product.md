...
Universo Platformo is a platform for creating metahubs — structured data management systems with entity architecture, publications, and modules capabilities. Built on an inherited upstream shell, it extends the core framework with multi-user functionality through Supabase.
...
-   **Modules**: Server-side and client-side modules with isolated-vm for secure execution
...
-   Embedded modules with server/client execution
