---
inclusion: auto
name: memory-bank-compression
description: Use when running the MB mode compression pipeline (refreshing canon files, applying compression strategies, validating size/structure/freshness, and generating the compression report) for Memory Bank files.
---
