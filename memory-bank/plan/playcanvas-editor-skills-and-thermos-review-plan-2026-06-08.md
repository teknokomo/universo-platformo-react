...
> Brief: local manager-only PlayCanvas Editor Skills and Thermos review brief, dated 2026-06-08
    ...
    describe('PlayCanvas Editor Skills structure', () => {
        ...
        for (const skill of EDITOR_SKILLS) {
            it(`${skill} has valid SKILL.md with required front-matter`, () => {
                const content = readFileSync(`.agents/skills/${skill}/SKILL.md`, 'utf-8')
