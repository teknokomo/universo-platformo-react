...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| private Manager brief                                                                                                                                         | Local brief                    | Current 2026-06-01                               | Defines the intended scope: metahub package settings and safe authoring host only, no scene persistence or full Editor backend integration.                           |
| private Manager source input                                                                                                                                  | Local source TZ                | Current local file                               | Original product and architecture request for PlayCanvas Editor integration into Platformo/MMOOMM.                                                                    |
