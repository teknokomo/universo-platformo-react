...
> Created: 2026-05-31
> Status: Draft
> Trigger: RESEARCH request for `.manager/specs/platformo/playcanvas-editor-package-foundation-spec-2026-05-31.md`
...
| `.manager/specs/platformo/playcanvas-editor-package-foundation-spec-2026-05-31.md` | Local brief | Current | Defines intended scope: package foundation only, no storage bridge, no Colyseus authoring, no AI/MCP. |
...
- `.manager/specs/platformo/playcanvas-editor-package-foundation-spec-2026-05-31.md`
