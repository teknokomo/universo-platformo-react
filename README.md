...
[![Version](https://img.shields.io/badge/version-0.78.0--alpha-blue)](https://github.com/teknokomo/universo-platformo-react)
...
**Current version**: 0.78.0-alpha (August 2026). The project remains in alpha and is being prepared for a more stable beta phase.
