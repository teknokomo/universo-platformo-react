...
exports.createTimeSyncEstimator = createTimeSyncEstimator;
function createTimeSyncEstimator(windowSize = 20, emaAlpha = 0.2) {
    const samples = [];
    let state = { offsetMs: 0, rttMs: 0, jitterMs: 0 };
    const compute = () => {
