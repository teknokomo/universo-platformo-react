...
// TODO: Import these types when @universo/publish-srv is available
// import {
//     IUPDLPosition,
//     IUPDLRotation,
//     IUPDLObject,
...
// Temporary type definitions until publish-srv is available
interface IUPDLPosition { x: number; y: number; z: number }
interface IUPDLRotation { x: number; y: number; z: number }
interface IUPDLObject { id: string; name: string; type: string; position: IUPDLPosition; rotation: IUPDLRotation; scale: IUPDLPosition; color: string;[key: string]: any }
interface IUPDLCamera { id: string; name: string; type: string; position: IUPDLPosition; rotation: IUPDLRotation; scale: IUPDLPosition;[key: string]: any }
interface IUPDLLight { id: string; name: string; type: string; position: IUPDLPosition; rotation: IUPDLRotation; scale: IUPDLPosition;[key: string]: any }
interface IUPDLData { id: string; name: string; dataType: string; content: string; isCorrect: boolean;[key: string]: any }
interface IUPDLSpace { id: string; name: string; objects: IUPDLObject[]; cameras: IUPDLCamera[]; lights: IUPDLLight[]; datas: IUPDLData[];[key: string]: any }
interface IUPDLScene { spaceId: string; spaceData: any; dataNodes: any[]; objectNodes: any[];[key: string]: any }
interface IUPDLMultiScene { scenes: IUPDLScene[]; currentSceneIndex: number; totalScenes: number; isCompleted: boolean }
