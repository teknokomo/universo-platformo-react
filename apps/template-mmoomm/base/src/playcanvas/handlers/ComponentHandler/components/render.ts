export default function render(id: string, props: any): string {
    ...
    const renderComponent = {
        ...
        applyToEntity(entity) {
            ...
            // Prevent default ship logic from overriding component-based material
            entity.__hasRenderComponent = true;
        }
    };

    if (window && window.DEBUG_MULTIPLAYER) console.log('[MMO Component] Render component ${id} ready');
    `
}
