...
export const updateDomain = (id: string, data: { name: string; description?: string }) =>
...
export const getDomainResources = (domainId: string) =>
    apiClient.get<Resource[]>(`/domains/${domainId}/resources`)
...
export const removeResourceFromDomain = (resourceId: string) =>
    apiClient.delete<void>(`/resources/${resourceId}/domain`)
