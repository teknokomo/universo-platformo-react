// TypeScript declarations for JSX components from packages/ui
declare module '*.jsx' {
  const content: any;
...
declare module '@ui/ui-component/cards/ItemCard' {
  const ItemCard: any;
  export default ItemCard;
}

declare module '@ui/ui-component/table/FlowListTable' {
