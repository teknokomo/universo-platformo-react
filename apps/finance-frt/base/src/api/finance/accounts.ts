...
export const updateAccount = (unikId: string, id: string, data: any) => api.put(`/uniks/${unikId}/finance/accounts/${id}`, data)
export const deleteAccount = (unikId: string, id: string) => api.delete(`/uniks/${unikId}/finance/accounts/${id}`)
