...
import { ARJSExporter, ARJSExportOptions, arjsExporter } from '../arjs/ARJSExporter'
import { AFrameVRExporter, AFrameVRExportOptions, aframeVRExporter } from '../aframe-vr/AFrameVRExporter'
...
export class ExporterFactory {
    ...
    static initialize(): void {
        this.registerExporter(TechnologyType.ARJS, arjsExporter)
        this.registerExporter(TechnologyType.AFRAME_VR, aframeVRExporter)
    ...
    static createExporter(type: TechnologyType, options?: ExportOptions): BaseExporter {
        ...
        if (exporter) {
            ...
            if (type === TechnologyType.ARJS && options) {
                ...
                const arjsExporter = exporter as ARJSExporter
                // Future: Add code to configure AR.js options
            } else if (type === TechnologyType.AFRAME_VR && options) {
