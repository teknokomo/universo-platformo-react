...
import { ExporterFactory, TechnologyType } from '../miniapps/exporters/ExporterFactory'
import { ExportOptions } from '../miniapps/exporters/BaseExporter'
import { ARJSExportOptions } from '../miniapps/arjs/ARJSExporter'
import { AFrameVRExportOptions } from '../miniapps/aframe-vr/AFrameVRExporter'
...
export function generateAFrameVRHTML(scene: UPDLScene, options?: AFrameVRExportOptions): string {
    return generateHTML(scene, TechnologyType.AFRAME_VR, options)
}
