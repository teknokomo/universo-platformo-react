...
/**
 * Simple UPDL interfaces (to avoid circular dependencies)
 */
interface Vector3 {
    x: number
    y: number
...
interface UPDLObject extends UPDLEntity {
    type: string
    color?: Color
    width?: number
    height?: number
...
interface UPDLCamera extends UPDLEntity {
    type: string
    fov?: number
    near?: number
    far?: number
...
interface UPDLLight extends UPDLEntity {
    type: string
    color?: Color
    intensity?: number
    distance?: number
