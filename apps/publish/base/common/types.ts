// Universo Platformo | UPDL Common Types for Publish
// Local definition of UPDL interfaces for use in the publish module

/**
 * Base interface for UPDL Flow used in the publish module
 */
