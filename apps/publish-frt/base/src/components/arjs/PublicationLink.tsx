// Universo Platformo | Component for displaying and copying AR.js publication link
...
export const PublicationLink: React.FC<PublicationLinkProps> = ({ url }) => {
        ...
        >
            ...
            >
                ...
                <Box sx={{ ml: 1, display: 'flex' }}>
                    <Tooltip title={copied ? t('publish.success.copied') : t('publish.arjs.copyLink')}>
                        <IconButton size='small' onClick={handleCopy} color={copied ? 'success' : 'default'}>
                            {copied ? <DoneIcon fontSize='small' /> : <ContentCopyIcon fontSize='small' />}
                        </IconButton>
                    </Tooltip>

                    <Tooltip title={t('publish.arjs.viewAR')}>
