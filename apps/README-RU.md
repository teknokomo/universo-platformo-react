...
```
apps/
├── universo-platformo-types/  # Общие TypeScript типы и интерфейсы
...
│       ├── tsconfig.json
│       └── README.md
├── universo-platformo-utils/  # Общие утилиты и процессоры
...
**Документация:** [apps/universo-platformo-types/base/README.md](./universo-platformo-types/base/README.md)
...
**Документация:** [apps/universo-platformo-utils/base/README.md](./universo-platformo-utils/base/README.md)
...
**Документация:** [apps/template-quiz/base/README.md](./template-quiz/base/README.md)
...
**Документация:** [apps/template-mmoomm/base/README.md](./template-mmoomm/base/README.md)
