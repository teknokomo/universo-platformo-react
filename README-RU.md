...
**Текущий спринт**: 0.40.0-alpha (Декабрь 2025)
...
Этот проект реализуется по [Омской Открытой Лицензии](https://universo.pro/ol) (Базовая модификация). Отдельные пакеты в `packages/` могут иметь другую лицензию, уточняйте лицензию в каждом отдельном пакете.
