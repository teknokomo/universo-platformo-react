...
Review runtime MUI implementation or metadata changes for control choice, DataGrid display, dashboard-template consistency, and generic runtime reuse.
