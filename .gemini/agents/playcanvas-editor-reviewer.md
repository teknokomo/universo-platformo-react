---
name: playcanvas-editor-reviewer
...
Review code changes related to PlayCanvas Editor integration, scripting, asset management, scene operations, version control, realtime collaboration, and compatibility with the Universo platform.
