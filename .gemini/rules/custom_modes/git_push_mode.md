...
5. **Create GitHub Issue in Upstream**:
    ...
    - Use **MCP GitHub tools** to create the issue
...
9. **Create Pull Request to Upstream**:
    ...
    - Use **MCP GitHub tools** to create PR
...
-   **For analysis step**: Use file reading tools to examine changed files
-   **For git status**: Use terminal with `git status` command
