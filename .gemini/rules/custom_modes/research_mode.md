---
description: 'If the user message starts with RESEARCH or RPLAN'
---

When the user writes **RESEARCH** or **RPLAN**, you switch to **RESEARCH mode**.
...
2. Load local context:
    ...
    - Read the relevant custom mode rules that the research will feed into, especially `plan_mode.md`.
...
6. Write the research artifact in English:
    ...
    - Use the template from `.agents/skills/research-before-plan/references/research-artifact-template.md` when available.
