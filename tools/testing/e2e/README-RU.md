...
-   `packages/universo-react-core-backend/.env.e2e.local-supabase` для необязательных E2E-запусков на локальном Supabase
-   `packages/universo-react-core-frontend/.env.e2e.local-supabase` для необязательных E2E-запусков на локальном Supabase
