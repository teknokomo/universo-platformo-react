...
export const backendRootDir = path.resolve(repoRoot, 'packages/universo-react-core-backend')
export const frontendRootDir = path.resolve(repoRoot, 'packages/universo-react-core-frontend')
