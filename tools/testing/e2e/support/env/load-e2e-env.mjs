...
export const backendRootDir = path.resolve(repoRoot, 'packages/universo-core-backend')
export const frontendRootDir = path.resolve(repoRoot, 'packages/universo-core-frontend')
