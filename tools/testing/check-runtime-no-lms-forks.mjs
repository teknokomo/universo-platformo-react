...
const SCANNED_DIRS = ['packages/universo-react-apps-template-mui/src', 'packages/universo-react-applications-frontend/src', 'packages/universo-react-applications-backend/src']
