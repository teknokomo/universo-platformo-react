...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@universo/types$': path.join(repoRoot, 'packages/universo-types/base/src/index.ts'),
    '^@universo/types/(.*)$': path.join(repoRoot, 'packages/universo-types/base/src/$1'),
    '^@universo/scripting-engine$': path.join(repoRoot, 'packages/scripting-engine/base/src/index.ts'),
    '^@universo/scripting-engine/(.*)$': path.join(repoRoot, 'packages/scripting-engine/base/src/$1'),
