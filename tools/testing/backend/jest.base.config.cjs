...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@universo/modules-engine$': path.join(repoRoot, 'packages/modules-engine/base/src/index.ts'),
    '^@universo/modules-engine/(.*)$': path.join(repoRoot, 'packages/modules-engine/base/src/$1'),
