...
export type SupabaseHandler = (context: SupabaseQueryContext) => Promise<{ data?: any; error?: any }> | { data?: any; error?: any }
...
const resolveResult = async (handler: SupabaseHandler | undefined, context: SupabaseQueryContext) => {
    if (!handler) {
