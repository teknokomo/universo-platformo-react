...
import { configureStore, type EnhancedStore, type Reducer, type AnyAction } from '@reduxjs/toolkit'
...
export interface RenderWithProvidersOptions<S extends DefaultState = DefaultState> extends Omit<RenderOptions, 'wrapper'> {
    theme?: Theme
...
export function createTestStore<S extends DefaultState = DefaultState>(options: CreateTestStoreOptions<S> = {}): EnhancedStore<S> {
