...
const requiredScreenshotPages = [
    ...
    'platform/metahubs/module-scopes.md',
    'platform/metahubs/modules.md',
    ...
    'platform/metahubs/shared-modules.md',
    'platform/spaces.md',
...
const screenshotExemptPages = new Set([
    ...
    'platform/multiplayer-realtime.md',
    'platform/projects-entity-type.md',
    'platform/thermos-review.md',
    'platform/playcanvas-editor-compatibility-v2-30-4.md',
    'platform/playcanvas-engine-ledger-2-18-1-to-2-21-4.md',
