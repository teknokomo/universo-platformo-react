...
The Resources page presents the metahub and shared-library choices as scopes inside one Modules tab.
...
-   In Resources → Modules, choose the shared-library scope (`general/library`) when the code should be reused and imported by other modules.
