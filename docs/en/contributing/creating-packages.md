...
-   For wrapper packages exposed through the metahub package registry, keep README wording aligned with the seeded runtime targets and pinned upstream versions in `pnpm-workspace.yaml`.
