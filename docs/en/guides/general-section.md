---
description: How to use the metahub Common section as the real entrypoint for global layouts and catalog layout navigation.
---

# Common Section

The Common page is the real authoring entrypoint for layouts in a metahub.
...
1. Create or open a global layout from Common -> Layouts.
...
The platform now keeps layout authoring behind one tabbed Common surface.
