...
- shared field-definition, fixed-value, and option-value pools that can be inherited by compatible entity types;
...
3. Switch between Layouts, Field Definitions, Fixed Values, Option Values, and Scripts depending on the shared asset you need.
...
1. Create shared field definitions, fixed values, or option values from the corresponding Resources tab.
