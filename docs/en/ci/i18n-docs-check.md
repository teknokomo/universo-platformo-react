...
- `resources` — only pairs related to Resources apps (`packages/resources-frontend`, `packages/resources-backend`) and their app docs (`docs/en|ru/applications/resources/README.md`)
