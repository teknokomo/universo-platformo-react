# Running Universo Platformo behind company proxy

If you're running Universo Platformo in an environment that requires a proxy, such as within an organizational network, you can configure Universo Platformo to route all its backend requests through a proxy of your choice. This feature is powered by the `global-agent` package.

[https://github.com/gajus/global-agent](https://github.com/gajus/global-agent)

## Configuration

There are 2 environment variables you will need to run Universo Platformo behind a company proxy:
