...
- общие пулы атрибутов, констант и значений, которые могут наследоваться совместимыми типами сущностей;
...
3. Переключайтесь между вкладками «Макеты», «Атрибуты», «Константы», «Значения» и «Скрипты» в зависимости от нужного общего ресурса.
...
1. Создавайте общие атрибуты, константы или значения на соответствующей вкладке «Ресурсы».
