...
_Рабочее пространство сущностей, показывающее все типы сущностей, включая Страницы_
...
-   **Компонент**: `EditorJsBlockEditor` из `@universo-react/template-mui`
-   **Валидация Бэкенда**: `PageBlockContentSchema` из `@universo-react/types`
-   **Рендеринг в Рантайме**: Универсальные рендереры блоков в `@universo-react/apps-template-mui`
...
-   [Модули Метахаба](metahub-modules.md) - Добавление модулей к Страницам
