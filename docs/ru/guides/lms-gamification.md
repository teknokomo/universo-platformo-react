...
-   `PointAwardRules` хранит детерминированные правила начисления баллов, например завершённый учебный контент, принятые assignments и manual adjustments.
...
Для повседневной работы внутри опубликованного LMS-приложения используйте [Опыт учащегося](../lms/learner-experience.md).
