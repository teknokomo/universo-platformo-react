...
![Дашборд рантайма LMS с демо-данными](../.gitbook/assets/lms-user-guide/dashboard-overview.png)
...
![Экран результата гостевого LMS-потока](../.gitbook/assets/lms-user-guide/guest-access-step-5.png)
