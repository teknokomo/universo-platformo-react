...
В LMS MVP тот же виджет квиза может встраиваться из элемента учебного контента, но сохранённая fixture квиза и это руководство по-прежнему описывают отдельный сценарий квиза на скриптах.
