---
description: Как catalog-specific layout наследуются от global layout, хранят sparse overrides для visibility и placement и управляют catalog runtime behavior из рабочего пространства ресурсов.
---
...
2. Перейдите в рабочее пространство ресурсов -> Layouts для глобального контекста или откройте route catalog, который ведёт в его список layout.
