...
- выверенную основную навигацию, где видны только ключевые продуктовые разделы, а дополнительные пункты уходят в overflow.
...
Если у приложения включены рабочие пространства, публичные приложения автоматически получают заполненное общее рабочее пространство `Опубликованное` во время синхронизации схемы.
Публичный рантайм привязывает данные к этому общему рабочему пространству ссылки доступа или текущей гостевой сессии, а не к произвольному активному рабочему пространству и не к personal-строкам пользователей.
