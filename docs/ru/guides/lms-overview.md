...
- классы, подразделения и каталог студентов как обычные сущности метахаба;
- учебные ресурсы, курсы, разделы курсов, модули и шаги учебных треков как Catalog-backed метаданные;
- каталоги тестов, попытки, ответы и фиксацию прогресса;
- отправку и проверку заданий, посещаемость мероприятий, сертификаты, закладки базы знаний и планы развития;
- Catalog-backed определения отчётов в `Reports`, выполняемые через generic runtime datasource descriptors;
