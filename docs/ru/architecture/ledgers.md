...
Runtime Object rows остаются пользовательской операционной поверхностью, а Регистры предназначены для posting, reporting, projections и script-controlled fact append flows.
