...
![Общие компоненты в Ресурсах](../.gitbook/assets/entities/shared-components.png)
...
- Общие компоненты, константы и значения живут в виртуальных общих контейнерах внутри `_mhb_objects`.
...
- Общие компоненты объектов принадлежат `shared-object-pool`.
