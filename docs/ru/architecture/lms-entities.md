...
Платформа по-прежнему поддерживает script-backed widgets и QR widgets как общие возможности, но LMS fixture не привязывает глобальные content/statistics/QR widgets в default application layout.
