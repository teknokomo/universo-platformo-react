...
2. Компоненты включают возможности вроде схемы данных, иерархии, связей, действий, событий, макетов и модулей.
...
-   `@universo-react/metahubs-backend` владеет определениями сущностей, действиями, привязками событий и метаданными публикаций.
-   `@universo-react/metahubs-frontend` владеет рабочим пространством Entities и проектированием экземпляров пользовательских сущностей.
-   `@universo-react/applications-backend` и `@universo-react/applications-frontend` потребляют опубликованные разделы в рантайме.
