...
Все приложения следуют последовательной модульной структуре, разработанной для масштабируемости и поддерживаемости:
...
├── publish-frt/         # Фронтенд системы публикации
