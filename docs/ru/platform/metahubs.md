...
Записи каталога используют тот же паттерн владения сущностью: пресет даёт сфокусированное представление проектирования, а сам объект всё равно участвует в общей модели сущностей.

![Записи каталога](../.gitbook/assets/entities/catalog-records.png)
