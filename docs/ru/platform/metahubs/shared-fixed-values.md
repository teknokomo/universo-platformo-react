...
Это позволяет хранить одно определение константы в центральной точке, пока несколько совместимых типов сущностей наследуют один источник проектирования.

![Общие константы](../../.gitbook/assets/entities/shared-constants.png)

## Правила проектирования

- Создавайте константу из вкладки «Константы», когда её должны переиспользовать несколько наборов или совместимых типов сущностей.
