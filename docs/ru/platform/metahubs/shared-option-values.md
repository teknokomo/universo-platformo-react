...
Это позволяет одному значению оставаться переиспользуемым, пока несколько совместимых типов сущностей наследуют одну исходную строку.

![Общие значения](../../.gitbook/assets/entities/shared-values.png)

## Правила проектирования

- Создавайте значение из вкладки «Значения», когда один и тот же смысл должен появляться более чем в одном перечислении или совместимом типе сущности.
