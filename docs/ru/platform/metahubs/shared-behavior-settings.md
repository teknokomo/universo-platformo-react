...
![Список общих констант, использующий настройки общего поведения](../../.gitbook/assets/entities/shared-constants.png)
...
- Общие компоненты и общие константы сохраняют `sharedBehavior` в `uiConfig.sharedBehavior`.
...
- Унаследованные виджеты используют ту же модель поведения через конфигурацию базового виджета и точечные переопределения виджетов объекта.
