...
Backend предоставляет endpoints модели хранения для будущего Editor bridge:
...
Визуальное редактирование сцен, iframe bridge messaging и эмуляция backend API PlayCanvas Editor всё ещё отложены до следующего среза интеграции.
...
-   PlayCanvas Editor iframe bridge и storage adapter.
