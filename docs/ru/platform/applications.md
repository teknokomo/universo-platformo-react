...
Когда `workspacesEnabled` включён, рабочие данные рантайма привязываются к личному рабочему пространству.
Владелец и участник получают рабочее пространство во время начальной подготовки или выдачи доступа, рантайм-строки разрешаются внутри этого рабочего пространства, а поддерживаемые лимиты каталогов применяются на уровне рабочего пространства, а не глобально.
