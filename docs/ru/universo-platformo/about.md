...
-   Контекст приложения метавселенных: см. Metaverse Backend → [applications/metaverse/metaverse-backend.md](../applications/metaverse/metaverse-backend.md)
...
-   Импорт и конвертация в контексте метавселенных: см. [Metaverse Backend](../applications/metaverse/metaverse-backend.md#интеграции-и-конвертация)
