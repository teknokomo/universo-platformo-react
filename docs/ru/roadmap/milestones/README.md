...
- ✅ **economy-frontend/srv**: Базовая экономика с валютой Inmo
...
- 🔄 **trading-frontend/srv**: Продвинутая торговая система
...
#### Новые приложения
- **workflow-engine-backend**: Движок выполнения Chatflow
